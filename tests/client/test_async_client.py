...
@respx.mock
@pytest.mark.asyncio
async def test_async_client_empty_ids():
...
@respx.mock
@pytest.mark.asyncio
async def test_async_client_429_retry():
    respx.post("https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi").mock(
        side_effect=[
...
@respx.mock
@pytest.mark.asyncio
async def test_async_client_http_error_retry():
    respx.post("https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi").mock(
        side_effect=[
            httpx.Response(500),
            httpx.Response(500),
...
@respx.mock
@pytest.mark.asyncio
async def test_async_client_max_retries_exceeded():
    respx.post("https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi").mock(
...
@respx.mock
@pytest.mark.asyncio
async def test_async_client_http_exception():
    respx.post("https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi").mock(
...
@respx.mock
@pytest.mark.asyncio
async def test_async_client_http_exception_max():
    respx.post("https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi").mock(
        return_value=httpx.Response(500)
    )
